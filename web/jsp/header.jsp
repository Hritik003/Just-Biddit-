    ...
    <head>
        ...
        <style>
            ...
            #createbids{    
                ...
                border-bottom: 3px solid var(--site_blue);
            }
    ...
    <body>
        <div class="header">
            <a class="logo" href="homepage">
                <img alt="homepage" title="biddit" src="./img/logo/logo.png">
            </a>
            ...
            <div class="icon_list">
                <a href="profile_login.jsp"><img  id="signup_icon" src="./img/icons/profile_login_icon.png"  alt="" title=""></a>
                <!--                if visitor-->
